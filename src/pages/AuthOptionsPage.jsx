  ...
  return (
    <div className="auth-shell relative overflow-hidden"
      ...
      <div className="page-shell flex min-h-[75vh] items-center justify-center py-8" >
        <section className="card relative w-full max-w-5xl overflow-hidden bg-blue-200/90 backdrop-blur-sm">
          <div
            ...
            <div className="mt-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              <article className="rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <Link to="/signup" className="btn-secondary w-full justify-center">Sign Up</Link>
                </div>
              </article>

              <article className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-4">
                <h3 className="text-lg font-semibold text-emerald-900">Doctor Access</h3>
                <p className="mt-1 text-sm text-slate-600">Access your workspace, view appointments, and patients.</p>
                <div className="mt-4">
                  <Link to="/doctor-login" className="btn-primary w-full justify-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600">Doctor Login</Link>
                </div>
              </article>

              <article className="rounded-2xl border border-slate-200 bg-white p-4">
                <h3 className="text-lg font-semibold">Hospital Admin</h3>
                <p className="mt-1 text-sm text-slate-600">Manage hospital profile, doctors, and operations.</p>
                <div className="mt-4 flex gap-2 flex-col">
                  <Link to="/hospital-login" className="btn-primary w-full justify-center">Admin Login</Link>
                  <Link to="/hospital-signup" className="btn-secondary w-full justify-center">Register Hospital</Link>
                </div>
              </article>

              <article className="rounded-2xl border border-slate-200 bg-white/70 p-4">
                <h3 className="text-lg font-semibold">Super Admin</h3>
                <p className="mt-1 text-sm text-slate-600">Platform management and hospital approvals.</p>
                <div className="mt-4">
                  <Link to="/super-admin-login" className="btn-secondary w-full justify-center">Login</Link>
                </div>
              </article>
            </div>
          </div>
